                        ...
                        <div class="col-lg-6 shadow-lg">
                            <div class="card-body p-md-5 mx-md-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3 class="mt-1 mb-5 pb-1">موقع الاسترشادي لطلاب الثانويه</h3>
                                </div>
...
@csrf
                        ...
                        <div class="col-lg-6 shadow d-flex align-items-center gradient-custom-2">
                            <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                <h4 class="mb-4 text-center">موقع الاسترشادي لطلاب الثنوية </h4>
                                <p class=" mb-0 text-end">
                                    كثير من الطلاب يجدون صعوبة في معرفة الطريقة الأمثل لتحقيق النجاح الأكاديمي والتفوق في مجالاتهم الدراسية المختلفة. لذلك، يأتي موقع استرشادي للطلاب لتوفير المعلومات والإرشاد اللازم لهم لتحقيق أهدافهم الأكاديمية.
                                </p>
                                <p class=" mb-0 text-end">
                                    يعتبر موقع استرشادي للطلاب مصدرًا شاملاً يوفر المشورة والموارد التعليمية للطلاب في كافة مستوياتهم التعليمية، بدءًا من المدارس الابتدائية وحتى المرحلة الجامعية. يهدف الموقع إلى مساعدة الطلاب على فهم المناهج الدراسية، وتنمية مهاراتهم الأكاديمية، وتطوير استراتيجيات الدراسة الفعالة.
                                </p>
                                <p class=" mb-0 text-end">
                                </p>
