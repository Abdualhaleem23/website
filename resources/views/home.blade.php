                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4 shadow-lg">
                            <div class="card-body" dir="rtl">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">@if(Auth::user()->specialty == 1) علمي @elseif(Auth::user()->specialty == 2) ادبي@endif }}</p>
                                    </div>
                                </div>
                                <hr>
                                @endif
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">سنة التخرج</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">{{ Auth::user()->graduation }}</p>
                                    </div>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4 mb-md-0">
                                    <div class="card-body">
                                        ...
                                        <section id="team" class="team_area section-padding">
                                            <div class="container">
                                                <h2 class="title_spectial text-center">تم الاجابه عليهم</h2>
                                                <hr>
                                                <div class="row text-center ">
                                                    @forelse($Student as $value)
                                                    @if(App\Http\Controllers\HomeController::student_answer_send($value->student_id) == 0)
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4 mb-md-0">
                                    <div class="card-body">
                                        <p class="mb-4 text-center"><span class="text-primary font-italic me-1"> مقرارات التخصص</span>
                                        </p>
                                        <hr>
                                        ...
                                        <div class="text-center">
                                            <button class="btn btn-sm btn-primary mt-2 w-25" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $value->id }}">اضافة </button>
                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('student-add-grades') }}" class="modal-body">
                                                        <div class="my-3 input-group">
                                                            ...
                                                            <input class="form-control" max="{{ $value->d1 }}" type="number" name="grades" />
                                                            <label class="input-group-text"> ادخل درجة المقرر</label>
                                                            <input type="hidden" required name="cores_id" value="{{ $value->id }}">
